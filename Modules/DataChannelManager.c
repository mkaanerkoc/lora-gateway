...
void InitializeDataChannelManager(void)
{
	...
	ChannelManager_AddChannel(5	, BME280_AIR_PRESSURE		, ANALOG_INPUT_CHANNEL,	FLOAT_TYPE,	60000	, 2000, 3,		104 );
	ChannelManager_AddChannel(5	, BME280_ALTITUDE			, ANALOG_INPUT_CHANNEL,	FLOAT_TYPE,	60000	, 2000, 3,		INVALID_MODBUS_REGISTER_ADDRESS );
	ChannelManager_AddChannel(5 , MAX31865_2_TEMPERATURE 	, ANALOG_INPUT_CHANNEL, FLOAT_TYPE, 60000   , 2000, 3,   	106 );
	ChannelManager_AddChannel(5 , INA219_SOLAR_CURRENT 		, ANALOG_INPUT_CHANNEL, FLOAT_TYPE, 60000   , 2000, 3,   	108 );
	ChannelManager_AddChannel(5 , INA219_SOLAR_VOLTAGE 		, ANALOG_INPUT_CHANNEL, FLOAT_TYPE, 60000   , 2000, 3,   	110 );
	ChannelManager_AddChannel(5	, BME280_HUMIDITY			, ANALOG_INPUT_CHANNEL,	FLOAT_TYPE,	60000	, 2000, 3,		112 );
	...
	ChannelManager_AddChannel(10 , BME280_AIR_PRESSURE		, ANALOG_INPUT_CHANNEL,	FLOAT_TYPE,	60000	, 2000, 3,		204 );
	...
	ChannelManager_AddChannel(10 , MAX31865_2_TEMPERATURE 	, ANALOG_INPUT_CHANNEL, FLOAT_TYPE, 60000   , 2000, 3,   	206 );
	ChannelManager_AddChannel(10 , INA219_SOLAR_CURRENT 	, ANALOG_INPUT_CHANNEL, FLOAT_TYPE, 60000   , 2000, 3,   	208 );
	ChannelManager_AddChannel(10 , INA219_SOLAR_VOLTAGE 	, ANALOG_INPUT_CHANNEL, FLOAT_TYPE, 60000   , 2000, 3,   	210 );
	ChannelManager_AddChannel(10 , BME280_HUMIDITY			, ANALOG_INPUT_CHANNEL,	FLOAT_TYPE,	60000	, 2000, 3,		212 );
